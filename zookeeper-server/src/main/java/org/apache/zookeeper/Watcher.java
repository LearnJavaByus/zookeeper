...
public interface Watcher {
     ...
     *
     * Watcher的内部类，无任何方法  .表示事件代表的状态
     */
    @InterfaceAudience.Public
    public interface Event {
        /**
         * Enumeration of states the ZooKeeper may be at the event
         * Event的内部类，表示Zookeeper所处的状态
         */
        @InterfaceAudience.Public
        public enum KeeperState {
             ...
             * to any server in the ensemble. // 断开*/
            Disconnected (0),
             ...
             * instance) if you with to access the ensemble.  // 过期状态*/
            Expired (-112),
        ...
        public enum EventType {
            ...
            NodeCreated (1), // 结点创建
            NodeDeleted (2), // 结点删除
            NodeDataChanged (3),   // 结点数据变化
            NodeChildrenChanged (4),  // 结点子节点变化
            DataWatchRemoved (5),  // 数据移除
            ChildWatchRemoved (6);  // 子节点数据移除
            // 代表事件类型的整形
            private final int intValue;     // Integer representation of value
                                            // for sending over wire
